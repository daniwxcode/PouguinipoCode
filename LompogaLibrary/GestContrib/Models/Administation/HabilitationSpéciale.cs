...
namespace LompogaLibrary.Administation
{
    ...
    public class HabilitationSpéciale : Habilitations
    {
        ...
        [Display(Name = "Utilisateur", AutoGenerateField = false, Order = 2, Prompt = @"Selectionner l'utilisateur concerné", GroupName = "Habilitation", Description = "Utilisateur beneficiant du droit")]
